        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                  '평균 속도: ${(_totalDistance / _elapsedTime.inSeconds * 3.6).toStringAsFixed(1)} km/h'),
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: _isTracking
                ? _pauseTracking
                : (_startTime == null ? _startTracking : _resumeTracking),
            tooltip: _isTracking
                ? '일시정지'
                : (_startTime == null ? '추적 시작' : '추적 재시작'),
          ),
          if (_startTime != null)
            IconButton(
                ...
                child: Column(
                  children: [
                    ...
                    LinearProgressIndicator(
                      value: widget.routePath.isEmpty
                          ? 0
                          : (_completedPath.length / widget.routePath.length)
                              .clamp(0.0, 1.0),
